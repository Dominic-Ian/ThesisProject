...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App.MauiApiConsumer.OnCompleteListener, App.MauiApiConsumer", OnCompleteListener.class, __md_methods);
	}
	...
	public OnCompleteListener ()
	{
		...
		if (getClass () == OnCompleteListener.class) {
			mono.android.TypeManager.Activate ("App.MauiApiConsumer.OnCompleteListener, App.MauiApiConsumer", "", this, new java.lang.Object[] {  });
		}
	}
