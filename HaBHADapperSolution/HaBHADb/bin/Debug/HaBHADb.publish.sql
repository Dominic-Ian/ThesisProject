...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Amenities]...';


GO
ALTER TABLE [dbo].[Amenities]
    ADD DEFAULT NEWID() FOR [AmenityId];
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[BoardingHouses]...';


GO
ALTER TABLE [dbo].[BoardingHouses]
    ADD DEFAULT NEWID() FOR [BoardinghouseId];
...
ALTER TABLE [dbo].[BookingTransactions]
    ADD DEFAULT NEWID() FOR [BookingTransactionId];
...
ALTER TABLE [dbo].[ClientRequests]
    ADD DEFAULT NEWID() FOR [ClientRequestId];
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[ImageFiles]...';
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Images]...';


GO
ALTER TABLE [dbo].[Images]
    ADD DEFAULT NEWID() FOR [ImageId];
