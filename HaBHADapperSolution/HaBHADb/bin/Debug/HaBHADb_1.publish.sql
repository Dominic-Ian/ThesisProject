...
GO
/*
The column [dbo].[Images].[BoardinghouseId] is being dropped, data loss could occur.
*/
...
GO
PRINT N'Altering Table [dbo].[Images]...';


GO
ALTER TABLE [dbo].[Images] DROP COLUMN [BoardinghouseId];
